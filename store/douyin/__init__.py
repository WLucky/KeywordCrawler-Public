...
async def update_douyin_aweme(aweme_item: Dict):
    ...
    save_content_item = {
        ...
        "video_favorite_count": str(interact_info.get("collect_count")),
        "video_comment": str(interact_info.get("comment_count")),
        "video_share_count": str(interact_info.get("share_count")),
        "last_modify_ts": utils.get_current_timestamp(),
        "video_url": f"https://www.douyin.com/video/{aweme_id}",
        "video_cover_url": _extract_content_cover_url(aweme_item),
